...
public class UtilGrafos {
    ...
    public static void imprimirMatrizBoolean(boolean[][] matriz, Map<Comparable, TVertice> vertices) {
        Object[] etiquetas = vertices.keySet().toArray();
        System.out.print("  ");
        for (int i = 0; i < matriz.length; i++) {
            System.out.print(etiquetas[i] + "  ");
    ...
    public static void imprimirMatrizMejoradoBoolean(boolean[][] matriz, Map<Comparable, TVertice> vertices, String titulo) {
        if (vertices != null && matriz.length == vertices.keySet().size()) {
            ...
            for (int i = 0; i < matriz.length; i++) {
                ...
                for (int j = 0; j < matriz.length; j++) {
                    if (matriz[i][j]) {
                        System.out.print(rellenar("1", largo, ' '));
                    } else {

                        System.out.print(rellenar("0", largo, ' '));
                    }
                }
                System.out.println();
                System.out.println(linea);
