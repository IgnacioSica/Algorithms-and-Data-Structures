...
public class TreeNode<T> extends Node<T> implements iTreeNode<T>{
    ...
    @Override 
    public iTreeNode<T> getLeft() { return this.left; }
    
    @Override 
    public iTreeNode<T> getRight() { return this.right; }
        
    @Override
    public void setLeft(iTreeNode<T> Left) { this.left = Left; }
    
    @Override 
    public void setRight(iTreeNode<T> Right) { this.right = Right; }
    
    @Override
    public int getAVLHeight() { return this.height; }
    
    @Override
    public void setAVLHeight(int newHeight) { this.height = newHeight; }
