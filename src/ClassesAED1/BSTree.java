...
public class BSTree<T> implements iBSTree<T>{
    ...
    @Override
    public iTreeNode<T> getRoot()                   { return root; }
    ...
    @Override
    public int getSize()                            { return isEmpty() ? 0 : this.root.getSize(); }

    @Override
    public int getHeight()                          { return isEmpty() ? -1 : this.root.getHeight(); }
    
    @Override
    public String print()                           { return isEmpty() ? "" : this.root.print(); }

    @Override
    public iTreeNode<T> search(Comparable Label)    { return isEmpty() ? null : this.root.search(Label); }
